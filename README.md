...
1. Clone the repository:
   ```bash
   git clone [https://github.com/Dafr1502/my-resume.git](https://github.com/Dafr1502/my-resume.git)
...
* Base template adapted and customized from open-source community templates.
